/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9f9a25f014e7d8a0dde054185d65d8ef)
// Runtime types generated with workerd@1.20250902.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ATOM_CACHE: KVNamespace;
		ATOMSPACE_MODE: "development";
		ATOMSPACE: DurableObjectNamespace<import("./src/index").AtomSpace>;
		MIND_AGENT: DurableObjectNamespace<import("./src/index").MindAgent>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ATOMSPACE_MODE">> {}
}
